...
public class Tags
{
    ...
    private static IEnumerable<PairTags> GetNotIncludeTag(List<PairTags> pairTags, TagInfo insideTagInfo,
        TagInfo outTagInfo)
    {
    ...
    private static IEnumerable<Tag> GetNotPairTags(List<Tag> tags) =>
        tags.Where(tag => tag.Name is TagInfo.H1 or TagInfo.Shield or TagInfo.Link);

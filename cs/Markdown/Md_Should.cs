...
namespace Markdown
{
    ...
    public class Md_Should
    {
        ...
        [TestCase("", "<p></p>")]
        [TestCase(" *красный *синий *зеленый", "<p><ul><li>красный</li><li>синий</li><li>зеленый</li></ul></p>")]
        [TestCase("_текст_ *_тест_ *тест *тест", "<p><em>текст</em><ul><li><em>тест</em></li><li>тест</li><li>тест</li></ul></p>")]
        [TestCase(" *тест *тест *тест", "<p><ul><li>тест</li><li>тест</li><li>тест</li></ul></p>")]

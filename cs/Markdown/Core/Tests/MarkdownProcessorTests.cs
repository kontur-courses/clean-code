...
namespace Markdown.Core.Tests
{
    ...
    public class MarkdownProcessorTests
    {
        ...
        public string RenderToHtml_ShouldReturnCorrect_WhenPairedUnderscoresInText(string text) => processor.Render(text);
        ...
        public string RenderToHtml_ShouldReturnUnchanged_WhenUnpairedUnderscoresInText(string text) => processor.Render(text);
        ...
        public string RenderToHtml_ShouldReturnUnchanged_WhenCommentedUnderscores(string text) => processor.Render(text);
        ...
        public string RenderToHtml_ShouldPairClosestUnderscores_WhenOddNumberOfUnderscores(string text) => processor.Render(text);
        ...
        public string RenderToHtml_ShouldReturnUnchanged_WhenAllUnderscoreNeighborsAreDigits(string text) => processor.Render(text);
        ...
        public string RenderToHtml_ShouldConvertUnderscore_WhenUnderscoreHasNonDigitNeighbor(string text) => processor.Render(text);
        ...
        public string RenderToHtml_ShouldIgnoreStartUnderscore_WhenSpaceAfterIt(string text) => processor.Render(text);
        ...
        public string RenderToHtml_ShouldIgnoreEndUnderscore_WhenSpaceBeforeIt(string text) => processor.Render(text);
    }
}
...
!\[Текст](Выделенный таким образом) должен быть преобразован в Html тег изображения (<img src=\"Выделенный таким образом\" alt=\"Текст\">)
...
\\!\[Тег](экранированный таким образом) не должен преобразовываться в html тег.
...
!\[\_Внутри\_](У \_\_тега\\\_\_) изображения другие теги не считаются тегами и не должны преобразовываться, включая их возможное экранирование (<img src=\"У _\_тега\\\_\_\" alt=\"\_Внутри\_\">)

!\[Однако](Экранирование\\\\) другого символа экрана должно быть скрыто при преобразовании (<img src=\"Экранирование\\\" alt=\"Однако\">)

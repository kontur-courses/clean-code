...
# Картинка
Строка, обернутая в символы @ выделяется тегом \<img>, внутри нее должны быть перечислены параметры src и alt, разделенные пробелом.
Внутри тега картинки не работают никакие другие теги, внутри тега должен быть хотя бы один пробельный символ

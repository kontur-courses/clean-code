...
Текст ссылки разделяется [квадратными скобками].

Текст, помещенный в квадратные скобки - это текст ссылки. 

Сразу после закрывающей квадратной скобки идёт набор обычных круглых скобок, 
внутри которых находится URL-адрес, на который вы хотите указать ссылку, 
вместе с необязательным заголовком ссылки, заключенным в кавычки.

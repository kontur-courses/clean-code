...
Строка [название ссылки](https://google.com/) выделится тэгом \<a> с атрибутом href в ссылку.

Таким образом, [название ссылки](https://google.com/) превратится в \<a href="https://google.com/">название ссылки\</a>.

* Между [название ссылки] и (ссылка) не должно быть никаких символов.
* Ссылку можно обернуть в теги курсивного и полужирного шрифта. 

    _[название ссылки](https://google.com/)_ -> \<em>\<a href="https://google.com/">название ссылки\</a>\</em>    
    
    __[название ссылки](https://google.com/)__ -> \<strong>\<a href="https://google.com/">название ссылки\</a>\</strong>

* Символы экранирования внутри тэга считаются простыми символами.

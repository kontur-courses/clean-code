...
namespace Markdown.Tests
{
    ...
    public class HtmlCreator_Should
    {
        ...
        public void SetUp()
        {
            creator = new HtmlCreator(new Dictionary<string, (string opening, string closing)>
            {
                ["_"] = ("<em>", "</em>"), ["*"] = ("<em>", "</em>"),
                ["__"] = ("<strong>", "</strong>"), ["**"] = ("<strong>", "</strong>")
            });
        }
        ...
        {
            var innerTokens = new List<Token> {new PairedTagToken(9, 10, "__nested__", "__")};
            creator.CreateFromTokens(new Token[]
                   {

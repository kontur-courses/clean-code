            ...
            yield return new TestCaseData(new IToken[]
                {
                    ...
                    new TagToken("__"),
                    new TextToken("\n")
                }, "<strong>abc cdef</strong>\n")
                .SetName("Double tags at the begin and at the end should br written correctly");
            yield return new TestCaseData(new IToken[]
                {
                    new TextToken("__"),
                    new TextToken("a"),
                ...
                .SetName("Double tags should be text when it at different lines");
        }

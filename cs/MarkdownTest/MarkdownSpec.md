...
Текст вида [link text](destination "alt text"), должен преобразовываться в <a href="destination", alt="alt text">link text</a>.

Поле "alt text" может отсутствовать.

Ссылка может находится внутри любых других тегов. Например # __text [link text](destination) text__ , примет вид
<h1> <strong>text <a href="destination">link text</a> text</strong></h1>
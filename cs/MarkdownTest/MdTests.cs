...
namespace MarkdownTest
{
    ...
    public class MdTests
    {
        ...
        private static TestCaseData[] mdTestCases =
        {
            ...
            new TestCaseData("цифрами_12_3").Returns("цифрами_12_3").SetName("DigitsItalicToken"),
            new TestCaseData("цифрами__12__3").Returns("цифрами__12__3").SetName("DigitsBoldToken"),
            ...
            new TestCaseData("_abc __abc abc__ abc __abc abc__ abc_").Returns("<em>abc __abc abc__ abc __abc abc__ abc</em>").SetName("FewBoldInsideItalic"),
            new TestCaseData("__1a__").Returns("<strong>1a</strong>").SetName("DigitAndLetterInToken"),
            new TestCaseData("__1234567a__").Returns("<strong>1234567a</strong>").SetName("DigitsAndLetter"),
            new TestCaseData("_a1_").Returns("<em>a1</em>").SetName("LetterAndDigitInToken"),
        };

...
public class Md_Should
{
    ...
    [TestCase(@"\__word word_", "_<em>word word</em>", TestName = "Backslash shield only one symbol")]
    [TestCase(@"_\word word_", @"<em>\word word</em>", TestName = "Backslash not shield not special symbol")]
    [TestCase(@"\\_word word_", @"\<em>word word</em>", TestName = "Backslash shield backslash")]
    ...
    [TestCase("_word __word_ word__", "_word _", TestName = "Intersecting tags don't work")]
    ...
    [TestCase("# header\nword", "<h1>header</h1>\nword", TestName = "Escape stop header")]

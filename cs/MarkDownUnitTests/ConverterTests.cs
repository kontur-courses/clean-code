...
namespace MarkDownUnitTests
{
    ...
    public class ConverterTests
    {
        ...
        [Test]
        public void Convert_ReturnsInitialText_WhenTextWithoutTags()
        {
            var inputText = "Text without tags";

            converter.Convert(inputText).Should().BeEquivalentTo(inputText);
        }
        ...
        public void Convert_ReturnsHtmlText_WhenTextWithMdItalicTag(string inputText, string convertedText)
        {
        ...
        public void Convert_ReturnsHtmlText_WhenTextWithMdBoldTag(string inputText, string convertedText)
        {
            var actualConvertedText = converter.Convert(inputText);
        ...
        public void Convert_ReturnsHtmlText_WhenTextWithMdHeaderTag(string inputText, string convertedText)
        {
            var actualConvertedText = converter.Convert(inputText);
        ...
        public void Convert_ReturnsHtmlText_WhenTextWithMdBoldAndItalicTags(string inputText, string convertedText)
        {
            var actualConvertedText = converter.Convert(inputText);
        ...
        public void Convert_ReturnsHtmlText_WhenTextWithEscapeCharacter(string inputText, string convertedText)
        {
            var actualConvertedText = converter.Convert(inputText);
        ...
        public void Convert_ReturnsHtmlText_WhenTextWithManyMdTags(string inputText, string convertedText)
        {
            var actualConvertedText = converter.Convert(inputText);
        ...
        [TestCase("Unordered list:\n" +
                  ...
                  "* paragraph C\n",
                "Unordered list:" +
                "<ul><li>paragraph A</li>" +
                "<li>paragraph B</li>" +
                "<li>paragraph C</li></ul>",
            TestName = "Unordered list")]
        public void Convert_ReturnsHtmlText_WhenTextWithMdUnorderedListTags(string inputText, string convertedText)
        {
            var actualConvertedText = converter.Convert(inputText);

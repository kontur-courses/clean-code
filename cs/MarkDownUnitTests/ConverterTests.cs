...
namespace MarkDownUnitTests
{
    ...
    public class ConverterTests
    {
        ...
        [TestCase("Space after opening_ italic_ tag", "Space after opening_ italic_ tag", TestName = "Italic opening tag doesn't work when space after")]
        [TestCase("Space before closing _italic _ tag", "Space before closing _italic _ tag", TestName = "Italic closing tag doesn't work when space before")]
        [TestCase("Italic tag inside digits _123_45", "Italic tag inside digits _123_45", TestName = "Italic tags inside digits don't work")]
        ...
        [TestCase("Space after opening__ bold__ tag", "Space after opening__ bold__ tag", TestName = "Bold opening tag doesn't work when space after")]

...
namespace Markdown
{
    ...
    public class TranslatorTests
    {
            ...
            public void SetUp()
            {
                _translator = new Translator('\\',new MarkHtml("__", "<strong>"), new MarkHtml("_", "<em>", false));
            }
            ...
            {
                _translator.Translate(text).Should().Be(text);
            }
            ...
            [TestCase("_abc__d__f_", "<em>abc__d__f</em>", TestName = "double underscores inside underscores in the middle")]
            ...
            [TestCase("_a1_2b_", "<em>a1_3b</em>", TestName = "opening underscore between digits that are inside underscores")]
            [TestCase("__a1_2b__", "<strong>a1_3b</strong>", TestName = "opening underscore between digits that are inside double underscores")]
            ...
            public void Translate_ReturnsCorrectString_On(string text, string expected)
            {
                _translator.Translate(text).Should().Be(expected);
            }
            ...
            public void Translate_AlgorithmicComplexityIsCloseToLinear()
            {
                ...
                GetTranslateTime(200);
                var secondResult = GetTranslateTime(200);
                GetTranslateTime(400);

...
namespace Markdown
{
    ...
    internal class ProcessorTests
    {
        ...
        [TestCase("__mad banana_", "_<em>mad banana</em>", TestName =
            "Double underscore and single underscore don't make pair")]
        ...
        [TestCase("[hey [bye](empty)](http://google.com)", "<a href=\"http://google.com\">hey [bye](empty)</a>",
            TestName = "External links are shown as common text")]

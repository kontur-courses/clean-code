...
Текст помещенный между круглых скобочек помещается в тег \<a\>\</a\>

Например (ulearn.me) превратится в html тег \<a href="ulearn.me">\</a\>

Ссылки не могут содержать или пересекаться с другими тегами, но могут содержаться внутри

Проверка корректности ссылки не производится, текст для помещения в ссылку должен соответствовать требованиям выделяющих тегов
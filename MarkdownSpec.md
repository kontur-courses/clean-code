...
Cсылка обозначается: [название](адрес), причем семантически и название и адрес могут быть любыми. 
Ссылка преобразуется в <a href="адрес">название</a>
В названии символы [ ] могут быть вложенными, например,  [[[название]]](адрес) должно обрабатыватсья как <a href="адрес">[[название]]</a>
Название должно преобразовываться в соотвествии с вышеизложенными правилами для других тегов, ссылка не должна

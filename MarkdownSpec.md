...
\[Текст, помещённый в квадратные скобки,\]\(после которого идёт текст, помещённый в круглые скобки\) помещается в тег \<a\> таким образом: 

\<a href="после которого идёт текст, помещённый в круглые скобки"\>Текст, помещённый в квадратные скобки,\</a\>

Внутри квадратных скобок сохранется форматирование, т.е. \[\_abc_\]\(def\) превратится в \<a href="def"\>\<em\>abc\</em\>\</a\>

Внутри круглых скобок форматирование отменяется, т.е. \[abс]\(\_def\_\) превратится в \<a href="\_def\_"\>abc\</a\>
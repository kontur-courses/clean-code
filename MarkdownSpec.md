...
Абзац, начинающийся с "* ", выделяется тэгом \<li> в пункт списка.
В тексте пункта списка могут присутствовать символы подчеркивания и экранизации с указанными правилами.

Подряд идущие пункты неупорядоченного списка выделяются тэгом \<ul> в неупорядоченный список

Таким образом

* Пункт __списка с _разными_ символами__

превратится в:

\<ul>\<li>Пункт \<strong>списка с \<em>разными\</em> символами\</strong>\</li>\</ul>

...
Элемент маркированного списка должен оборачиваться в соответствующие HTML теги и тег маркированного списка:
...
При работе с несколькими элементами списка, они вкладываются в теге маркированного списка:
...
При всем этом, тег должен работать только в начале строки.

Например, следующая строка не будет изменена

    First - item

Однако, если в начале строки будет знак элемента маркированного списка, то он обернет строку, но элемент, находившийся не в начале строки останется без изменений:

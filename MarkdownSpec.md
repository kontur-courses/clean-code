...
Ссылки обозначаются следующим образом: [отображаемое имя](www.example.com). 
Такие ссылки должны преобразоваться в html тег: <a href="www.example.com">отображаемое имя</a>
...
Любые сервисные знаки (подчерки, хэштеги, слеши) внутри ссылочной конструкции должны игнорироваться:
[\_отображаемое_имя_](www.exa__mp__le.com) должен конвертироваться в <a href="www.exa__mp__le.com">\_отображаемое_имя_</a>

Если перед первой открывающей скобкой расположен слэш: "\[", то дальнейшая конструкция невалидна.

Если между закрывающей квадратной скобкой и открывающей круглой существуют какие-либо символы, конструкция ссылки невалидна. 

...
Параграфы, начинающиеся с "* " являются элементами маркированного списка
В тексте элемента списка могут присутствовать все прочие символы разметки с указанными правилами.

Начало и конец каждого списка оборачивается в теги \<ul> и \</ul> 
Элементы списка оборачиваются в теги \<li> и \</li>
...
\<ul>\<li>Имя\</li>\<li>Фамилия\</li>\<li>Отчество\</li>\<li>Возраст\</li>\</ul>
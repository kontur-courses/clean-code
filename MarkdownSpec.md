...
Текст выделенный символами "|", оборачивается тегом \<ul>.
Внутри списка через пробел или подряд указываются его элементы выделяемые символами "*", оборачивается тегом <li>
Маркированный список может содержать внутри себя только элементы выделенные "*"

...
Текст, начинающийся с "* " представляет собой неупорядоченный (маркированный)список:
* Элемент списка
* Элемент списка
* Элемент списка

Каждый элемент списка, начинающийся с "* ", должен выделяться HTML-тегом \<li> вот так:

\<li> Элемент списка \</li>

Весь список должен обрамляться HTML-тегом \<ul> следующим образом:

\<ul>  
\<li> Элемент списка \</li> </p> 
\<li> Элемент списка \</li> </p> 
\<li> Элемент списка \</li> </p> 
\</ul> 

...
# Мой тег: Нумерованный список

Такс, получается что делает мой тег и как его использовать?

А все просто, выделяем то, что хотим поместить в нумерованный список моим MD тегом: *

Пример: \*Квас Картофель Вареная Колбаса Яйца Редис Огурцы Сметана Зелень Соль\* (Без \ знака)

На выходе получаем нумерованный список:
...
PS: В numeric точка не дожна быть, хз почему в md при внесение тега без нее не получется :(

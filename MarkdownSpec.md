...
Абзац, начинающийся с "- ", выделяется тегом \<li> в пункт списка.
Все последовательные пункты списка оборачиваются в тег \<ul>.
В тексте абзацов могут присутствовать все прочие символы разметки с указанными правилами.

Таким образом

- Пункты списка __с _разными_ символами__
- И __разными__ _тегами_

превратятся в:

\<ul>
\<li>Пункты списка \<strong>с \<em>разными\</em> символами\</strong>\</li>
\<li>И \<strong>разными\</strong> \<em>тегами\</em>\</li>
\</ul>
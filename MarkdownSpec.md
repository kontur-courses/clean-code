...
Ссылка должна быть окружена с двух сторон квадратными скобками []. 
Внутри скобок необходимо указать текст ссылки, а после закрывающей скобки - URL ссылки, окруженный с двух сторон круглыми скобками ().
При этом текст ссылки может содержать другие теги.
Например, [Текст_ссылки_](http://www.example.com).
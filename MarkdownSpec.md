...
Строка \[название ссылки](https://github.com/) превратится в \<a href="https://github.com/">название ссылки</a>.

* Между [название ссылки] и (ссылка) не должно быть никаких символов.
* При пересечении с другим парным тегом _[название_ссылки](ссылка)_ всё остаётся символами.
* Экранирование работает внутри и ссылки, и названия [\название\_ссылки](\_ссылка\_). При этом все символы экранирования будут удалены из результата.

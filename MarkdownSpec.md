...
Ссылки вида [Подпись](Источник) должны быть помещены в HTML-тэг <a href="Источник">Подпись</a> 
К примеру : [Google](https://google.com) преобразуется в \<a href="https://google.com">Google\</a>

Изображения записанные в виде ![АльтТекст](Источник) должны быть помещены в HTML-тэг \<img src="Источник" alt="АльтТекст">
К примеру : ![Котики](https://redpandashop.ru/image/cache/catalog/products/Print/kartina-memnye-kotiki-p53831-1-750x750.jpg)
преобразуется в \<img src="https://redpandashop.ru/image/cache/catalog/products/Print/kartina-memnye-kotiki-p53831-1-750x750.jpg" alt="Котики">

Нижние подчеркивания внутри ссылок записываются так как есть.

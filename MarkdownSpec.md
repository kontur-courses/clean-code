...
Строка [название ссылки](ссылка) превратится в <a href="ссылка">название ссылки</a>.

* Между ] и ( не должно быть никаких символов.
* При пересечении с другим парным тегом ссылка преобразуется, другой тег остаётся символами.
* Экранирование работает внутри и ссылки, и названия. При этом все символы экранирования будут удалены из результата.

...
# Описание реализации тегов по ДЗ

## Тег \#  
Тег преобразуется текст в вид заголовка. Может иметь уроветь от 1 до 6, преобразуется в HTML-тег \<h1>\</h1> - \<h6>\</h6>

## Тег \_ (\*)
Тег преобразует текст в emphasis вид, оборачивает текст в HTML-тег \<em>\</em>.

## Тег \__ (\*\*)
Тег преобразует текст в жирный текст, оборачивает текст в HTML-тег \<strong>\</strong>.

## Тег \<P>
Тег используется для обособления текста в абзацы. оборачивает текст в HTML-тег\<P>\</P>. Заголовки \<h1>\</h1> - \<h6>\</h6> в абзац не включаются. 

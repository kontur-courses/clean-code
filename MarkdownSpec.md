...
Чтобы создать маркерованный список, нужно после пробела поставить *.

Например, такая строка " *красный *синий *зеленый", должна превратиться в ненумерованный список:
/<ul><li>красный</li><li>синий</li><li>зеленый</li></ul>
...
Могут быть двух форматов: 
 - `[some Text Here](http://link.com/)` раскрывается в `<a href="http://link.com">some Text Here</a>` 
 - `(http://link.com/)` раскрывается в `<a href="http://link.com">http://link.com</a>` 
Могут быть экранированы, все другие теги внутри превращаются в обычный текст
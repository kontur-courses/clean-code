...
При наличии в тексте тега картинки в виде \!\[Alt Text](Some Path), он преобразуется в html-тег вида \<img src="Some Path" alt="Alt text">.

При отсутстии Alt text или Some Path их атрибуты alt или src соответственно будут отсутствовать в теле тега, но тег все еще будет оставаться валидным.

Так же возможно экранирование тега с помощью симовола '\\'.

Если существует открытый валидный тег картинки, то внутри него не работают любые другие теги.

Тег считается невалидным, если символы [,],(,) являются непарными в рамках одного абзаца.
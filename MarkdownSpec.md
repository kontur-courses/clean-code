...
Для создания ненумерованного списка нужно поставить перед каждым пунктом один из символов - `*`, `-`, `+` и пробельный символ "* " 

Каждый элемент списка начинается с новой строки, такой список
...
<pre><code class="language-html">&lt;ul&gt;&lt;li&gt;первый элемент&lt;/li&gt;&lt;li&gt;второй элемент&lt;/li&gt;&lt;li&gt;третий элемент&lt;/li&gt;&lt;/ul&gt;</code></pre>

Если у элементов маркированного списка отсутствует перенос строки - это строка, а не список:
* первый элемент * второй элемент * третий элемент

Если пробельный символ отсутствует - строка не считается элементом списка:
* первый элемент 
*второй элемент
* третий элемент

К элементам списка применима логика работы __полужирный__, _курсив_ и символов экранирования

...
Абзац, начинающийся с "* ", выделяется тегом \<li> в элемент маркированного списка.
В тексте элемента маркированного списка могут присутствовать все прочие символы разметки
с указанными правилами. n идущих подряд элементов маркированного списка
оборачиваются в тег \<ul>

Пример:

* текст _c_ __разными__
* символами

Превратится в:

\<ul>\<li>текст \<em>с\</em> \<strong>разными\</strong>\</li><br>\<li>символами\</li>\</ul>

...
Текст выделенный двумя символами <abc.def> превратится в \<a href="abc.def">abc.def\</a>
Некорректные ссылки не будет затронуты: <ab . cd> останется без изменений.

Текст выделенный символами [Имя ссылки](destination.com) превратится в \<a href="destination.com">Имя ссылки\</a>
Аналогично некорректные ссылки не будут изменены.
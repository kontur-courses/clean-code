...
* Абзац, начинающийся с "* ", "+ " или "- " выделяется тегом \<li>.
+ В тексте списка _могут_ __присутствовать__ все прочие символы разметки с указанными правилами.
- Если несколько строк начинаются с этих символов и стоят в одном абзаце, они выделяются тегом \<ul>

Если такие строки стоят в соседних абзацах, выделение тегами \<ul> дробится на каждый абзац
* вот так

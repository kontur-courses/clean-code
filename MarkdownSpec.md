...
Стандартная ссылка имеет вид [Название](ссылка) и должна преобразовываться в html следующим образом:
<a href="ссылка">Название</a>
Помимо этого есть ссылка с комментарием [Название](ссылка "комментарий") она должна преобразовываться в html следующим образом:
<a href="ссылка" title="комментарий">Название</a>

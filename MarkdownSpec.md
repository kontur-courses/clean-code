...
Для создания пунктов маркерованного списка используется символ *
* Если "*" находится не в начале строки - он считается за обычный символ
* В пункте списка могут сочетаться другие теги с учетом приведенных выше правил: курсив, выделение жирным
*После "*" может сразу идти текст

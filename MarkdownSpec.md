...
Картинка работает внутри других тегов  _![cat](https://i.ibb.co/fxwGJZB/image.png)_ 

Между ![альтернативным текстом] и (ссылкой) не должно быть символов

Можно экранировать символы разметки тега \![](), ![\]() или ![](\) не будут считаться картинками. Экранирование внутри 
текста и ссылки сохраняеться ![т\е\\кст]() и будет \<img src="" alt="т\е\\\\кст">

Тег считаеться законченным если только если он внутри одного абзаца ![](
) - не работает.

Строка ![cat](https://i.ibb.co/fxwGJZB/image.png) превратится в \<img src="https://i.ibb.co/fxwGJZB/image.png" alt="cat">
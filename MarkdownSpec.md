...
# Ссылки
Идущие подряд слова в квадратных и круглых скобках превратятся в ссылку (пометятся тегом \<a href>)

 \[слово](ссылка) превратится в \<a href="ссылка">слово\</a>.

 Внутри ссылок могут присутствовать все прочие символы разметки

...
последовательностью, содержащей от одной до шести решеточек и пробел,
и переводом строки должен обрабатываться как заголовок:
`# header1\n -> <h1>header1</h1>`
`# header5\n -> <h5>header1</h5>`

Внутри заголовков работают подчеркивания, например:
